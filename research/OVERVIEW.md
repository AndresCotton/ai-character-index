...
| `sweeps/02-calibration/` | Stage 4 only: `4-spec-coverage.md` (verdicts covered, constitution 3 / model spec 4) + committed `4-spec-coverage.json` sidecar (`engine/publish-coverage.py` prefers the sidecar) + `gates.md` (Gate 4 signed 2026-07-20) |
| `sweeps/03-action-honesty/` | Stage 4 only, same shape (constitution 3 / model spec 3), with a committed `4-spec-coverage.json` sidecar; Gate 4 signed 2026-07-20 |
