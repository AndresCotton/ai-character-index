...
- All five dated archives `openai-model-spec/docs/*.html` are 0-byte files, and `docs/index.html` has a malformed anchor (`<a href=2025-12-18.html">` — missing opening quote).
