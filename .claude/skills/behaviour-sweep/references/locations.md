...
| Sweep working record (stage artifacts + gate log) | `research/evals/NN-<slug>/` (see the orchestrator skill for the layout) |
...
| Reference sweep output (content templates) | `research/evals/01-no-sycophancy.md` and the behaviour-1 Notion pages (predate the staged layout; their content structure is still canonical) |
