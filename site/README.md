...
- `spec-reader-test/` — a copy of the reader carrying the v5 panel run's behaviour set, kept separate from what the index publishes. See [`spec-reader-test/README.md`](spec-reader-test/README.md).
