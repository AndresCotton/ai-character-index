...
The two engine verifiers (`engine/verify-reader-test.mjs`, `engine/verify-reader-features.mjs`) boot Chrome against these pages and assert every published passage anchors; run them after changing markup or payloads.
