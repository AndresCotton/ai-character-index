...
- `README.md`'s repo-map links resolve on main: `research/core-behaviour-list.md`, `.claude/skills/README.md`, `vision/features to build.md`, `engine/`, `site/`, `data/`; it points onward to `SYSTEM.md` for the system map and frames `PLAN.md` as the original design.
