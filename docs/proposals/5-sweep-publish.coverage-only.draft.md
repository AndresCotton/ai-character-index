...
> Rescoped replacement for `.claude/skills/5-sweep-publish/SKILL.md` under the model-spec-reader-only scope. Not a live skill — do not move under `.claude/skills/` until approved.
