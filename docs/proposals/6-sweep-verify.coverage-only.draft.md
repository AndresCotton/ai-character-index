> **Approved 2026-08-18** (repo-owner ruling, closeout list "Scope deletions" item: the `.claude/skills/` scope pass). This banner is stripped on promotion; the skills-pass PR promotes this file to `.claude/skills/6-sweep-verify/SKILL.md`.
